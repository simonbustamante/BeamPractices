...
//		Step 1 : Read csv file.
		...
		PCollection<String> order= pipeline.apply(TextIO.read().from("/home/sabb/Documents/Beam/Section9/user_order.csv"));
		PCollection<String> user= pipeline.apply(TextIO.read().from("/home/sabb/Documents/Beam/Section9/p_user.csv"));		
...
//		Step 4 : Convert PCollection<Row> to PCollection<String>
		...
		pOutput.apply(TextIO.write().to("/home/sabb/Documents/Beam/Section9/sql_join_output.csv").withNumShards(1).withSuffix(".csv"));
