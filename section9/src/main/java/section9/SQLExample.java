...
//beam sql allows a beam user to query PCollection with SQL Statement
...
//		Step 4 : Convert PCollection<Row> to PCollection<String>
		...
		pOutput.apply(TextIO.write().to("/home/sabb/Documents/Beam/Section9/sql_output.csv").withNumShards(1).withSuffix(".csv"));
